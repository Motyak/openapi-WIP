...
class AudiobookObject(BaseModel):
    ...
    __properties = ["authors", "available_markets", "copyrights", "description", "html_description", "edition", "explicit", "external_urls", "href", "id", "images", "languages", "media_type", "name", "narrators", "publisher", "type", "uri", "total_chapters", "chapters"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AudiobookObject:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of chapters
        if self.chapters:
            _dict['chapters'] = self.chapters.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> AudiobookObject:
        """Create an instance of AudiobookObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AudiobookObject.parse_obj(obj)

        _obj = AudiobookObject.parse_obj({
            ...
            "chapters": PagingSimplifiedChapterObject.from_dict(obj.get("chapters")) if obj.get("chapters") is not None else None
        })
        return _obj
