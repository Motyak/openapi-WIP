...
class PagingTrackObject(BaseModel):
    ...
    items: conlist(TrackObject) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagingTrackObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagingTrackObject:
        """Create an instance of PagingTrackObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagingTrackObject.parse_obj(obj)

        _obj = PagingTrackObject.parse_obj({
            "href": obj.get("href"),
            "limit": obj.get("limit"),
            "next": obj.get("next"),
            ...
            "total": obj.get("total"),
            "items": [TrackObject.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
