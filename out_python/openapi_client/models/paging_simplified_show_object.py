...
class PagingSimplifiedShowObject(BaseModel):
    ...
    items: conlist(SimplifiedShowObject) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagingSimplifiedShowObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagingSimplifiedShowObject:
        """Create an instance of PagingSimplifiedShowObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagingSimplifiedShowObject.parse_obj(obj)

        _obj = PagingSimplifiedShowObject.parse_obj({
            "href": obj.get("href"),
            "limit": obj.get("limit"),
            "next": obj.get("next"),
            ...
            "total": obj.get("total"),
            "items": [SimplifiedShowObject.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
