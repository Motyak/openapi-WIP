...
class PagingObject(BaseModel):
    ...
    __properties = ["href", "limit", "next", "offset", "previous", "total"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagingObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagingObject:
        """Create an instance of PagingObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagingObject.parse_obj(obj)

        _obj = PagingObject.parse_obj({
            "href": obj.get("href"),
            "limit": obj.get("limit"),
            "next": obj.get("next"),
