...
class PagingSimplifiedTrackObject(BaseModel):
    ...
    items: conlist(SimplifiedTrackObject) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagingSimplifiedTrackObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagingSimplifiedTrackObject:
        """Create an instance of PagingSimplifiedTrackObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagingSimplifiedTrackObject.parse_obj(obj)

        _obj = PagingSimplifiedTrackObject.parse_obj({
            "href": obj.get("href"),
            "limit": obj.get("limit"),
            "next": obj.get("next"),
            ...
            "total": obj.get("total"),
            "items": [SimplifiedTrackObject.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
