...
class PagingSavedShowObject(BaseModel):
    ...
    items: conlist(SavedShowObject) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagingSavedShowObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagingSavedShowObject:
        """Create an instance of PagingSavedShowObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagingSavedShowObject.parse_obj(obj)

        _obj = PagingSavedShowObject.parse_obj({
            "href": obj.get("href"),
            "limit": obj.get("limit"),
            "next": obj.get("next"),
            ...
            "total": obj.get("total"),
            "items": [SavedShowObject.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
