...
class GetMultipleArtists200Response(BaseModel):
    """
    GetMultipleArtists200Response
    """
    artists: conlist(ArtistObject) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetMultipleArtists200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetMultipleArtists200Response:
        """Create an instance of GetMultipleArtists200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetMultipleArtists200Response.parse_obj(obj)

        _obj = GetMultipleArtists200Response.parse_obj({
