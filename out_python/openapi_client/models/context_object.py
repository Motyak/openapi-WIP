...
class ContextObject(BaseModel):
    ...
    ContextObject
    """
    type: Optional[StrictStr] = Field(None, description="The object type, e.g. \"artist\", \"playlist\", \"album\", \"show\". ")
    ...
    uri: Optional[StrictStr] = Field(None, description="The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the context. ")
    __properties = ["type", "href", "external_urls", "uri"]
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContextObject:
        """Create an instance of ContextObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContextObject.parse_obj(obj)

        _obj = ContextObject.parse_obj({
            "type": obj.get("type"),
            "href": obj.get("href"),
