...
class EpisodeObject(BaseModel):
    ...
    __properties = ["audio_preview_url", "description", "html_description", "duration_ms", "explicit", "external_urls", "href", "id", "images", "is_externally_hosted", "is_playable", "language", "languages", "name", "release_date", "release_date_precision", "resume_point", "type", "uri", "restrictions", "show"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EpisodeObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EpisodeObject:
        """Create an instance of EpisodeObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EpisodeObject.parse_obj(obj)

        _obj = EpisodeObject.parse_obj({
