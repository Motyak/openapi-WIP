...
class PagingSimplifiedAudiobookObject(BaseModel):
    ...
    items: conlist(SimplifiedAudiobookObject) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagingSimplifiedAudiobookObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagingSimplifiedAudiobookObject:
        """Create an instance of PagingSimplifiedAudiobookObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagingSimplifiedAudiobookObject.parse_obj(obj)

        _obj = PagingSimplifiedAudiobookObject.parse_obj({
            "href": obj.get("href"),
            "limit": obj.get("limit"),
            "next": obj.get("next"),
            ...
            "total": obj.get("total"),
            "items": [SimplifiedAudiobookObject.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
