...
class SavedTrackObject(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SavedTrackObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SavedTrackObject:
        """Create an instance of SavedTrackObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SavedTrackObject.parse_obj(obj)

        _obj = SavedTrackObject.parse_obj({
