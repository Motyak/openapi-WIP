...
class PagingArtistObject(BaseModel):
    ...
    items: conlist(ArtistObject) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagingArtistObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagingArtistObject:
        """Create an instance of PagingArtistObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagingArtistObject.parse_obj(obj)

        _obj = PagingArtistObject.parse_obj({
            "href": obj.get("href"),
            "limit": obj.get("limit"),
            "next": obj.get("next"),
