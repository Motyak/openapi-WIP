...
class LinkedTrackObject(BaseModel):
    ...
    __properties = ["external_urls", "href", "id", "type", "uri"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LinkedTrackObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LinkedTrackObject:
        """Create an instance of LinkedTrackObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LinkedTrackObject.parse_obj(obj)

        _obj = LinkedTrackObject.parse_obj({
