...
class GetAUsersAvailableDevices200Response(BaseModel):
    """
    GetAUsersAvailableDevices200Response
    """
    devices: conlist(DeviceObject) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAUsersAvailableDevices200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAUsersAvailableDevices200Response:
        """Create an instance of GetAUsersAvailableDevices200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAUsersAvailableDevices200Response.parse_obj(obj)

        _obj = GetAUsersAvailableDevices200Response.parse_obj({
            "devices": [DeviceObject.from_dict(_item) for _item in obj.get("devices")] if obj.get("devices") is not None else None
        })
        return _obj
