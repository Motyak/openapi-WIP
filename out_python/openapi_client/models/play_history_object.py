...
class PlayHistoryObject(BaseModel):
    ...
    played_at: Optional[datetime] = Field(None, description="The date and time the track was played.")
    context: Optional[ContextObject] = None
    __properties = ["track", "played_at", "context"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PlayHistoryObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PlayHistoryObject:
        """Create an instance of PlayHistoryObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PlayHistoryObject.parse_obj(obj)

        _obj = PlayHistoryObject.parse_obj({
            "track": TrackObject.from_dict(obj.get("track")) if obj.get("track") is not None else None,
            "played_at": obj.get("played_at"),
