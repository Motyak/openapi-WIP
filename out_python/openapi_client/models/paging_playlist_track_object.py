...
class PagingPlaylistTrackObject(BaseModel):
    ...
    items: conlist(PlaylistTrackObject) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagingPlaylistTrackObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagingPlaylistTrackObject:
        """Create an instance of PagingPlaylistTrackObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagingPlaylistTrackObject.parse_obj(obj)

        _obj = PagingPlaylistTrackObject.parse_obj({
            "href": obj.get("href"),
            "limit": obj.get("limit"),
            "next": obj.get("next"),
            ...
            "total": obj.get("total"),
            "items": [PlaylistTrackObject.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
