...
class TrackRestrictionObject(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrackRestrictionObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrackRestrictionObject:
        """Create an instance of TrackRestrictionObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrackRestrictionObject.parse_obj(obj)

        _obj = TrackRestrictionObject.parse_obj({
