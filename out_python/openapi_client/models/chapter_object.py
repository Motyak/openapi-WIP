...
class ChapterObject(BaseModel):
    ...
    __properties = ["audio_preview_url", "available_markets", "chapter_number", "description", "html_description", "duration_ms", "explicit", "external_urls", "href", "id", "images", "is_playable", "languages", "name", "release_date", "release_date_precision", "resume_point", "type", "uri", "restrictions", "audiobook"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChapterObject:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of audiobook
        if self.audiobook:
            _dict['audiobook'] = self.audiobook.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChapterObject:
        """Create an instance of ChapterObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChapterObject.parse_obj(obj)

        _obj = ChapterObject.parse_obj({
            ...
            "audiobook": SimplifiedAudiobookObject.from_dict(obj.get("audiobook")) if obj.get("audiobook") is not None else None
        })
        return _obj
