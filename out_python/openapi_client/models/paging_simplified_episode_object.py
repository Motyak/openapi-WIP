...
class PagingSimplifiedEpisodeObject(BaseModel):
    ...
    items: conlist(SimplifiedEpisodeObject) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagingSimplifiedEpisodeObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagingSimplifiedEpisodeObject:
        """Create an instance of PagingSimplifiedEpisodeObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagingSimplifiedEpisodeObject.parse_obj(obj)

        _obj = PagingSimplifiedEpisodeObject.parse_obj({
            "href": obj.get("href"),
            "limit": obj.get("limit"),
            "next": obj.get("next"),
            ...
            "total": obj.get("total"),
            "items": [SimplifiedEpisodeObject.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
