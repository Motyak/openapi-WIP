...
class SavedAlbumObject(BaseModel):
    ...
    album: Optional[AlbumObject] = None
    __properties = ["added_at", "album"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SavedAlbumObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SavedAlbumObject:
        """Create an instance of SavedAlbumObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SavedAlbumObject.parse_obj(obj)

        _obj = SavedAlbumObject.parse_obj({
            "added_at": obj.get("added_at"),
            "album": AlbumObject.from_dict(obj.get("album")) if obj.get("album") is not None else None
        })
        return _obj
