...
class SimplifiedPlaylistObject(BaseModel):
    ...
    __properties = ["collaborative", "description", "external_urls", "href", "id", "images", "name", "owner", "public", "snapshot_id", "tracks", "type", "uri"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SimplifiedPlaylistObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SimplifiedPlaylistObject:
        """Create an instance of SimplifiedPlaylistObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SimplifiedPlaylistObject.parse_obj(obj)

        _obj = SimplifiedPlaylistObject.parse_obj({
            ...
            "tracks": PlaylistTracksRefObject.from_dict(obj.get("tracks")) if obj.get("tracks") is not None else None,
            "type": obj.get("type"),
            "uri": obj.get("uri")
        })
        return _obj
