...
class ChapterRestrictionObject(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChapterRestrictionObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChapterRestrictionObject:
        """Create an instance of ChapterRestrictionObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChapterRestrictionObject.parse_obj(obj)

        _obj = ChapterRestrictionObject.parse_obj({
