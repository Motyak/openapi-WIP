...
class CurrentlyPlayingContextObject(BaseModel):
    ...
    repeat_state: Optional[StrictStr] = Field(None, description="off, track, context")
    shuffle_state: Optional[StrictBool] = Field(None, description="If shuffle is on or off.")
    ...
    __properties = ["device", "repeat_state", "shuffle_state", "context", "timestamp", "progress_ms", "is_playing", "item", "currently_playing_type", "actions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CurrentlyPlayingContextObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CurrentlyPlayingContextObject:
        """Create an instance of CurrentlyPlayingContextObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CurrentlyPlayingContextObject.parse_obj(obj)

        _obj = CurrentlyPlayingContextObject.parse_obj({
            "device": DeviceObject.from_dict(obj.get("device")) if obj.get("device") is not None else None,
            "repeat_state": obj.get("repeat_state"),
            "shuffle_state": obj.get("shuffle_state"),
