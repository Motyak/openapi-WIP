...
class PagingSavedAudiobookObject(BaseModel):
    ...
    items: conlist(SavedAudiobookObject) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagingSavedAudiobookObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagingSavedAudiobookObject:
        """Create an instance of PagingSavedAudiobookObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagingSavedAudiobookObject.parse_obj(obj)

        _obj = PagingSavedAudiobookObject.parse_obj({
            "href": obj.get("href"),
            "limit": obj.get("limit"),
            "next": obj.get("next"),
            ...
            "total": obj.get("total"),
            "items": [SavedAudiobookObject.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
