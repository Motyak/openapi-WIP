...
class PagingSavedAlbumObject(BaseModel):
    ...
    items: conlist(SavedAlbumObject) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagingSavedAlbumObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagingSavedAlbumObject:
        """Create an instance of PagingSavedAlbumObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagingSavedAlbumObject.parse_obj(obj)

        _obj = PagingSavedAlbumObject.parse_obj({
            "href": obj.get("href"),
            "limit": obj.get("limit"),
            "next": obj.get("next"),
            ...
            "total": obj.get("total"),
            "items": [SavedAlbumObject.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
