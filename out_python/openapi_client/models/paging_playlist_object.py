...
class PagingPlaylistObject(BaseModel):
    ...
    items: conlist(SimplifiedPlaylistObject) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagingPlaylistObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagingPlaylistObject:
        """Create an instance of PagingPlaylistObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagingPlaylistObject.parse_obj(obj)

        _obj = PagingPlaylistObject.parse_obj({
            "href": obj.get("href"),
            "limit": obj.get("limit"),
            "next": obj.get("next"),
            ...
            "total": obj.get("total"),
            "items": [SimplifiedPlaylistObject.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
