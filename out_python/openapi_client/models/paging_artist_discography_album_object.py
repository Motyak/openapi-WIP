...
class PagingArtistDiscographyAlbumObject(BaseModel):
    ...
    items: conlist(ArtistDiscographyAlbumObject) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagingArtistDiscographyAlbumObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagingArtistDiscographyAlbumObject:
        """Create an instance of PagingArtistDiscographyAlbumObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagingArtistDiscographyAlbumObject.parse_obj(obj)

        _obj = PagingArtistDiscographyAlbumObject.parse_obj({
            "href": obj.get("href"),
            "limit": obj.get("limit"),
            "next": obj.get("next"),
            ...
            "total": obj.get("total"),
            "items": [ArtistDiscographyAlbumObject.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
