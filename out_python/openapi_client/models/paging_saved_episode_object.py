...
class PagingSavedEpisodeObject(BaseModel):
    ...
    items: conlist(SavedEpisodeObject) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagingSavedEpisodeObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagingSavedEpisodeObject:
        """Create an instance of PagingSavedEpisodeObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagingSavedEpisodeObject.parse_obj(obj)

        _obj = PagingSavedEpisodeObject.parse_obj({
            "href": obj.get("href"),
            "limit": obj.get("limit"),
            "next": obj.get("next"),
            ...
            "total": obj.get("total"),
            "items": [SavedEpisodeObject.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
