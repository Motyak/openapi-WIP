...
class PublicUserObject(BaseModel):
    ...
    __properties = ["display_name", "external_urls", "followers", "href", "id", "images", "type", "uri"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublicUserObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PublicUserObject:
        """Create an instance of PublicUserObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PublicUserObject.parse_obj(obj)

        _obj = PublicUserObject.parse_obj({
