...
class SimplifiedArtistObject(BaseModel):
    ...
    __properties = ["external_urls", "href", "id", "name", "type", "uri"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SimplifiedArtistObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SimplifiedArtistObject:
        """Create an instance of SimplifiedArtistObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SimplifiedArtistObject.parse_obj(obj)

        _obj = SimplifiedArtistObject.parse_obj({
