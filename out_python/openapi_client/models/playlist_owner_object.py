...
class PlaylistOwnerObject(BaseModel):
    ...
    __properties = ["external_urls", "followers", "href", "id", "type", "uri", "display_name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PlaylistOwnerObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PlaylistOwnerObject:
        """Create an instance of PlaylistOwnerObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PlaylistOwnerObject.parse_obj(obj)

        _obj = PlaylistOwnerObject.parse_obj({
