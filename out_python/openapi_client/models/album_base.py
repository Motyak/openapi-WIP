...
class AlbumBase(BaseModel):
    ...
    __properties = ["album_type", "total_tracks", "available_markets", "external_urls", "href", "id", "images", "name", "release_date", "release_date_precision", "restrictions", "type", "uri"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlbumBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AlbumBase:
        """Create an instance of AlbumBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AlbumBase.parse_obj(obj)

        _obj = AlbumBase.parse_obj({
