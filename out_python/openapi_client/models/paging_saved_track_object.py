...
class PagingSavedTrackObject(BaseModel):
    ...
    items: conlist(SavedTrackObject) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagingSavedTrackObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagingSavedTrackObject:
        """Create an instance of PagingSavedTrackObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagingSavedTrackObject.parse_obj(obj)

        _obj = PagingSavedTrackObject.parse_obj({
            "href": obj.get("href"),
            "limit": obj.get("limit"),
            "next": obj.get("next"),
            ...
            "total": obj.get("total"),
            "items": [SavedTrackObject.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
