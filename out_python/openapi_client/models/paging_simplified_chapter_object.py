...
class PagingSimplifiedChapterObject(BaseModel):
    """
    ...
    items: conlist(SimplifiedChapterObject) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagingSimplifiedChapterObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagingSimplifiedChapterObject:
        """Create an instance of PagingSimplifiedChapterObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagingSimplifiedChapterObject.parse_obj(obj)

        _obj = PagingSimplifiedChapterObject.parse_obj({
            "href": obj.get("href"),
            "limit": obj.get("limit"),
            "next": obj.get("next"),
            ...
            "total": obj.get("total"),
            "items": [SimplifiedChapterObject.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
