...
class EpisodeRestrictionObject(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EpisodeRestrictionObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EpisodeRestrictionObject:
        """Create an instance of EpisodeRestrictionObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EpisodeRestrictionObject.parse_obj(obj)

        _obj = EpisodeRestrictionObject.parse_obj({
