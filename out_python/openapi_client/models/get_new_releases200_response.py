...
class GetNewReleases200Response(BaseModel):
    """
    GetNewReleases200Response
    """
    albums: PagingSimplifiedAlbumObject = Field(...)
    __properties = ["albums"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetNewReleases200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetNewReleases200Response:
        """Create an instance of GetNewReleases200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetNewReleases200Response.parse_obj(obj)

        _obj = GetNewReleases200Response.parse_obj({
