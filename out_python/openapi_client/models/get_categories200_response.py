...
class GetCategories200Response(BaseModel):
    ...
    """
    categories: GetCategories200ResponseCategories = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetCategories200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetCategories200Response:
        """Create an instance of GetCategories200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetCategories200Response.parse_obj(obj)

        _obj = GetCategories200Response.parse_obj({
            "categories": GetCategories200ResponseCategories.from_dict(obj.get("categories")) if obj.get("categories") is not None else None
        })
        return _obj
