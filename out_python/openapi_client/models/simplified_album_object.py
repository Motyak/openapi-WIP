...
class SimplifiedAlbumObject(BaseModel):
    ...
    __properties = ["album_type", "total_tracks", "available_markets", "external_urls", "href", "id", "images", "name", "release_date", "release_date_precision", "restrictions", "type", "uri", "artists"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SimplifiedAlbumObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SimplifiedAlbumObject:
        """Create an instance of SimplifiedAlbumObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SimplifiedAlbumObject.parse_obj(obj)

        _obj = SimplifiedAlbumObject.parse_obj({
