...
class GetCategories200ResponseCategories(BaseModel):
    """
    ...
    items: conlist(CategoryObject) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetCategories200ResponseCategories:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetCategories200ResponseCategories:
        """Create an instance of GetCategories200ResponseCategories from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetCategories200ResponseCategories.parse_obj(obj)

        _obj = GetCategories200ResponseCategories.parse_obj({
            "href": obj.get("href"),
            "limit": obj.get("limit"),
            "next": obj.get("next"),
            ...
            "total": obj.get("total"),
            "items": [CategoryObject.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
