...
class ShowObject(BaseModel):
    ...
    __properties = ["available_markets", "copyrights", "description", "html_description", "explicit", "external_urls", "href", "id", "images", "is_externally_hosted", "languages", "media_type", "name", "publisher", "type", "uri", "total_episodes", "episodes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ShowObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ShowObject:
        """Create an instance of ShowObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ShowObject.parse_obj(obj)

        _obj = ShowObject.parse_obj({
