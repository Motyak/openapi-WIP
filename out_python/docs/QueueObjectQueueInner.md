...
queue_object_queue_inner_instance = QueueObjectQueueInner.from_json(json)
# print the JSON string representation of the object
print QueueObjectQueueInner.to_json()

# convert the object into a dict
queue_object_queue_inner_dict = queue_object_queue_inner_instance.to_dict()
# create an instance of QueueObjectQueueInner from a dict
queue_object_queue_inner_form_dict = queue_object_queue_inner.from_dict(queue_object_queue_inner_dict)
```
