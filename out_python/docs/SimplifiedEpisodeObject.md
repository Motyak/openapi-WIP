...
simplified_episode_object_instance = SimplifiedEpisodeObject.from_json(json)
# print the JSON string representation of the object
print SimplifiedEpisodeObject.to_json()

# convert the object into a dict
simplified_episode_object_dict = simplified_episode_object_instance.to_dict()
# create an instance of SimplifiedEpisodeObject from a dict
simplified_episode_object_form_dict = simplified_episode_object.from_dict(simplified_episode_object_dict)
```
